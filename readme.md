...
과제를 통해 일주일이라는 짧은 시간동안 많은 성장을 할 수 있었습니다. 특히 개념만 알던 delegate 로 view controller 간 데이터를 전달하는 방식을 완전히 이해하게 된 점이 가장 뿌듯합니다. 전반적으로 개념만으로 알고 지나갔던 부분들을 UIKit 에서 어떻게 추상화 시키고 사용할 수 있는지를 알게되었습니다.

과제를 할수록 실제 서비스 되는 앱은 어떻게 구현되어 있는지 더 궁금해졌습니다. 구글링을 통해 나오는 튜토리얼은 매우 단편적이고 작은 부분만 나와있었습니다. 그래서 여러가지 view 나 view controller를 중첩하는 구조에서는 어떤 처리가 깔끔한지 알아보고 싶습니다.

이번 과제를 통해서 제 스스로에게 큰 성장이 되었다고 느낍니다. 좋은 기회주셔서 감사합니다.
